        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-blue-600 px-8 py-6">
            ...
            {meta && (
              <div className="text-indigo-100 mt-2 text-sm">
                <p>
                  <span className="font-semibold">Report Type:</span> {meta.reportType || 'N/A'}
                </p>
                <p>
                ...
                {meta.criteria && (
                  <p>
                    ...
                    {meta.criteria.from} - {meta.criteria.to}
                  </p>
                )}
              </div>
            )}
          ...
          <div className="px-8 pb-8">
            <button
              ...
              className="w-full bg-indigo-600 text-white font-semibold py-3 px-6 rounded-xl transition-all hover:bg-indigo-700 active:scale-95 disabled:bg-gray-300 disabled:cursor-not-allowed shadow-lg flex items-center justify-center gap-2"
            >
              <svg
                className="w-5 h-5"
                fill="none"
